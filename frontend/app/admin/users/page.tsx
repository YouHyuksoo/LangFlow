      ...
      <Tabs defaultValue="users" className="space-y-6">
        ...
        <TabsContent value="users" className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="stat-card relative overflow-hidden">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">신규 사용자 (1주)</CardTitle>
        ...
        <TabsContent value="personas" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>사용자의 AI 페르소나를 관리합니다. 각 페르소나는 시스템 메시지를 포함합니다.</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center space-x-2">
                          ...
                          <Badge variant="secondary">페르소나</Badge>
                        </div>
  ...
  return (
    <div className="space-y-4">
      {pendingUsers.map((user) => (
        <Card key={user.user_id} className="border-l-4 border-accent">
                ...
                <div className="flex gap-2 ml-4">
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      ...
                      <AlertDialogFooter>
                        <AlertDialogCancel>취소</AlertDialogCancel>
                        <AlertDialogAction onClick={() => handleApprove(user.user_id)}>
                          승인
                        </AlertDialogAction>
                      </AlertDialogFooter>
                    </AlertDialogContent>
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      ...
                      <AlertDialogFooter>
                        <AlertDialogCancel>취소</AlertDialogCancel>
                        <AlertDialogAction onClick={() => handleReject(user.user_id)}>
                          거부
                        </AlertDialogAction>
                      </AlertDialogFooter>
                    </AlertDialogContent>
